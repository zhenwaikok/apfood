import 'dart:io';
import 'package:apfood/students/profile/model/profile_model.dart';
...
class ProfileViewModel extends ChangeNotifier{
  ...
  Future<void> saveProfilePic() async {
      ...
      if (currentUser != null)
      {
        ...
        final fileName = "${currentUser.uid}/${DateTime.now().millisecondsSinceEpoch}.jpg";
        final storageRef = FirebaseStorage.instance.ref().child("ProfileImage").child(fileName);
